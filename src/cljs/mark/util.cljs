...
#_(defn init-scroll [{:keys [lastscroll]}]
...
#_(defn in-view [el opts]
    (js/Waypoint.
     (clj->js (-> {:element el}
                  (merge opts)))))


#_(defn keep-centered [state el offset]
    (in-view
     el
     {:offset offset
